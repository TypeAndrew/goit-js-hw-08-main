...
class InputSaver {
    CreateState(typeEL, valueEl) {
        ...
        if (typeEL === "email") settings.email = valueEl;
        if (typeEL === "textarea") settings.message = valueEl;
        localStorage.setItem("feedback-form-state", JSON.stringify(settings));
        console.log(settings);
    }
    listenInput() {
        let getEl = (selector)=>document.querySelector(selector);
        getEl(".feedback-form").addEventListener("input", (0, _lodashThrottleDefault.default)(()=>{
            if (event !== undefined) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","lodash.throttle":"bGJVT"}],"gkKU3":[function(require,module,exports) {
